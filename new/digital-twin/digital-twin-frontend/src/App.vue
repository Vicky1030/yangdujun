...
const difyChatUrl = import.meta.env.VITE_DIFY_CHAT_URL || 'http://localhost:8090/chat/IDCeWnE4p0dMGXW7'
  ...
  <main v-else class="dashboard-shell">
    ...
    <section class="ai-assistant-panel">
      <div class="panel-heading ai-heading">
        <div>
          <p class="panel-kicker">大模型辅助决策</p>
          <h2>智慧小菇 AI 种植助手</h2>
        </div>
        <span>DeepSeek-R1 8B + Dify 知识库</span>
      </div>
      <iframe
        class="dify-chat-frame"
        :src="difyChatUrl"
        title="智慧小菇 AI 种植助手"
        allow="microphone"
      />
