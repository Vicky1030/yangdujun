...
export const discardAiSuggestion = (id, payload) => http.post(`/ai/suggestions/${id}/discard`, payload)
export const directDownlinkAiSuggestion = (payload) => http.post('/ai/suggestions/direct-downlink', payload)
